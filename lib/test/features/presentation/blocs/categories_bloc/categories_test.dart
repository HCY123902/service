...
void main() {
  ...
  test(
      "should give a list of campus service model when the map is passed as an argument",
        ...
        print(categoriesMap["Academic Services"][0].title);
        print(categoriesMap["Academic Services"][0].description);
        print(categoriesMap["Academic Services"][0].contactNumber);
        print(categoriesMap["Academic Services"][0].emailAddress);
        //print(list);

        expect(categoriesMap, expectedMap);
      }
  );
}